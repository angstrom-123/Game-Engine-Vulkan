...
// {
//     m_Arrays[TEXTURE_ARRAY_COLOR_SMALL].Init(1024, sizes.colorSmall, VK_FORMAT_R8G8B8A8_SRGB, backend);
//     m_Arrays[TEXTURE_ARRAY_COLOR_LARGE].Init(2048, sizes.colorLarge, VK_FORMAT_R8G8B8A8_SRGB, backend);
//     m_Arrays[TEXTURE_ARRAY_DATA_SMALL].Init(1024, sizes.dataSmall, VK_FORMAT_R8G8B8A8_UNORM, backend);
//     m_Arrays[TEXTURE_ARRAY_DATA_LARGE].Init(2048, sizes.dataLarge, VK_FORMAT_R8G8B8A8_UNORM, backend);
...
// }
//
// AllocatedTexture TextureArrayHandler::AllocateTexture(ImageResource& imageData, VulkanBackend *backend)
// {
...
// }
//
// AllocatedTexture TextureArrayHandler::AllocateRaw(uint8_t *pixels, glm::ivec2 size, uint32_t flags, int32_t channels, VulkanBackend *backend)
// {
